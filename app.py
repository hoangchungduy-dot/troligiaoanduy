...
<div class="main-header">
    ...
    <p>Tác giả: Hoàng Thị Duy-Trường Tiểu học Vĩnh Thành - ĐT: 0839132530</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Hoàng Thị Duy - Trường Tiểu học Vĩnh Thành - ĐT: 0839132530</div>", unsafe_allow_html=True)
